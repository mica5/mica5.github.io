...
var _user$project$Poll$indexToLetter = function (index) {
	var _p0 = index;
	switch (_p0) {
		case 1:
			return 'A';
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {state: a, question: b, questionerChoice1: c, questionerChoice2: d, questionerChoice3: e, questionerChoice4: f, answerIndex: g, tempChosen: h, answerChoice1: i, answerChoice2: j, answerChoice3: k, answerChoice4: l};
											};
										};
									};
								};
...
var _user$project$Poll$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
					...
					switch (_p3) {
						case 1:
							return _elm_lang$core$Native_Utils.update(
								model,
								{questionerChoice1: _p4});
						case 2:
							return _elm_lang$core$Native_Utils.update(
								model,
								{questionerChoice2: _p4});
						case 3:
							return _elm_lang$core$Native_Utils.update(
								model,
								{questionerChoice3: _p4});
						case 4:
							return _elm_lang$core$Native_Utils.update(
								model,
								{questionerChoice4: _p4});
						default:
							return _elm_lang$core$Native_Utils.update(
								model,
								{questionerChoice1: _p4});
			...
			default:
				var newModel = function () {
					var _p5 = model.tempChosen;
					switch (_p5) {
						case 1:
							return _elm_lang$core$Native_Utils.update(
								model,
								{answerChoice1: model.answerChoice1 + 1});
						case 2:
							return _elm_lang$core$Native_Utils.update(
								model,
								{answerChoice2: model.answerChoice2 + 1});
						case 3:
							return _elm_lang$core$Native_Utils.update(
								model,
								{answerChoice3: model.answerChoice3 + 1});
						case 4:
							return _elm_lang$core$Native_Utils.update(
								model,
								{answerChoice4: model.answerChoice4 + 1});
						default:
							return model;
					}
				}();
...
var _user$project$Poll$Answer = {ctor: 'Answer'};
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$name('answer'),
									_1: {
										ctor: '::',
...
var _user$project$Poll$SetCorrectAnswer = function (a) {
	return {ctor: 'SetCorrectAnswer', _0: a};
};
var _user$project$Poll$SetAnswer = F2(
	function (a, b) {
		return {ctor: 'SetAnswer', _0: a, _1: b};
	});
var _user$project$Poll$question = F2(
	function (textValue, newAnswerIndex) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Poll$SetCorrectAnswer(newAnswerIndex)),
											_1: {ctor: '[]'}
										}
									}
								}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Enter your answer here.'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(
									_user$project$Poll$SetAnswer(newAnswerIndex)),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
...
var _user$project$Poll$SetQuestion = function (a) {
	return {ctor: 'SetQuestion', _0: a};
};
var _user$project$Poll$Submit = {ctor: 'Submit'};
var _user$project$Poll$questionView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder('Enter your question here.'),
											_1: {
												ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Set one answer as the correct answer.'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									...
									_1: {
										ctor: '::',
										_0: A2(_user$project$Poll$question, 'A', 1),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$br,
											...
											_1: {
												ctor: '::',
												_0: A2(_user$project$Poll$question, 'B', 2),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$br,
													...
													_1: {
														ctor: '::',
														_0: A2(_user$project$Poll$question, 'C', 3),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$br,
															...
															_1: {
																ctor: '::',
																_0: A2(_user$project$Poll$question, 'D', 4),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$br,
																	...
																	_1: {
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onClick(_user$project$Poll$Submit),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(model.question),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
															...
															{ctor: '[]'},
															{
																...
																_0: _elm_lang$html$Html$text(
																	A2(
																		...
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			_user$project$Poll$indexToLetter(model.answerIndex),
																			'.'))),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
...
var _user$project$Poll$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Poll$init,
		view: _user$project$Poll$view,
		update: _user$project$Poll$update,
...
var Elm = {};
Elm['Poll'] = Elm['Poll'] || {};
if (typeof _user$project$Poll$main !== 'undefined') {
    _user$project$Poll$main(Elm['Poll'], 'Poll', undefined);
}
