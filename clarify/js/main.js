...
var _mica5$clarify$Model$emptyTask = _mica5$clarify$Model$createEmptyTask(-1);
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {life_goals: a, todayTaskIds: b, tasks: c, debug: d, lifeGoalID: e, taskID: f, new_life_goal_title: g, newTaskRegister: h, state: i, settings: j};
									};
								};
							};
						};
				...
				if (_p1 === 'None') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								settings: {ctor: '::', _0: _p1, _1: cleanedSettings}
							}),
						{ctor: '[]'});
				}
			case 'ToggleSetting':
				var _p2 = _p0._0;
				var settings = A2(_elm_lang$core$List$member, _p2, model.settings) ? A2(
					_elm_lang$core$List$filter,
					function (s) {
						return !_elm_lang$core$Native_Utils.eq(s, _p2);
					},
					model.settings) : {ctor: '::', _0: _p2, _1: model.settings};
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								tasks: A2(
									_elm_lang$core$List$map,
									function (t) {
										return (!_elm_lang$core$Native_Utils.eq(t.taskID, _p5)) ? t : _elm_lang$core$Native_Utils.update(
											t,
											{lifeGoalID: _p3._0});
									},
									model.tasks),
								debug: A2(
									...
									A2(
										...
										A2(_elm_lang$core$Basics_ops['++'], '; goalID ', _p4)))
							}),
						{ctor: '[]'});
				}
			case 'UpdateTaskRegister':
				...
				switch (_p6) {
					case 'estimatedMinutes':
						var _p7 = _elm_lang$core$String$toInt(_p9);
						if (_p7.ctor === 'Err') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								model,
							...
							model,
							{
								debug: A2(
									...
									A2(
										...
										A2(_elm_lang$core$Basics_ops['++'], '; title ', _p11))),
								tasks: A2(
									_elm_lang$core$List$map,
									function (t) {
										return (!_elm_lang$core$Native_Utils.eq(t.taskID, _p12)) ? t : _elm_lang$core$Native_Utils.update(
											t,
											{title: _p11});
									},
									model.tasks)
							...
							model,
							{
								debug: A2(
									...
									A2(
										...
										A2(_elm_lang$core$Basics_ops['++'], '; estMinutesStr ', _p14))),
								tasks: A2(
									_elm_lang$core$List$map,
									function (t) {
										return (!_elm_lang$core$Native_Utils.eq(t.taskID, _p15)) ? t : _elm_lang$core$Native_Utils.update(
											t,
											{estimatedMinutes: _p13._0});
									},
									model.tasks)
							}),
						{ctor: '[]'});
							...
							model,
							{
								debug: A2(
									...
									A2(
										...
										A2(_elm_lang$core$Basics_ops['++'], '; title ', _p18))),
								life_goals: A2(
									_elm_lang$core$List$map,
									function (g) {
										return (!_elm_lang$core$Native_Utils.eq(g.id, _p17)) ? g : _elm_lang$core$Native_Utils.update(
											g,
											{title: _p18});
									},
									model.life_goals)
...
var _mica5$clarify$View$taskToHtmlDisplay = F2(
	function (model, task) {
		return {
			ctor: '::',
			_0: A2(
...
var _mica5$clarify$View$taskListToHtmlList = F2(
	function (model, tasks) {
		return A2(
			_elm_lang$core$List$map,
			function (task) {
				return A2(_mica5$clarify$View$taskToHtmlDisplay, model, task);
			},
			tasks);
	});
...
var _mica5$clarify$View$htmlAppHeader = A2(
	_elm_lang$html$Html$div,
	{
		...
		_0: _elm_lang$html$Html_Attributes$style(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'color', _1: '#1D417D'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'font-size', _1: '30px'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'padding-left', _1: '40%'},
						_1: {ctor: '[]'}
					}
				}
			}),
...
var _mica5$clarify$Main$defaultModel = _mica5$clarify$Model$Model(
	...
	{
		ctor: '::',
		_0: A5(_mica5$clarify$Model$Task, 'clean desk', false, 0, 0, -1),
		_1: {
			ctor: '::',
	...
	_mica5$clarify$Model$createEmptyTask(2))('TodayState')(
	{ctor: '[]'});
																							...
																							return A2(
																								...
																								function (todayTaskIds) {
																									return _elm_lang$core$Json_Decode$succeed(
																										{debug: debug, lifeGoalID: lifeGoalID, life_goals: life_goals, newTaskRegister: newTaskRegister, new_life_goal_title: new_life_goal_title, settings: settings, state: state, taskID: taskID, tasks: tasks, todayTaskIds: todayTaskIds});
																								},
																								A2(
